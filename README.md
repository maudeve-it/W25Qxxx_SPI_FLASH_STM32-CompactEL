...
|<b>Part two</b>|<b> "how to" create a low-RAM-demanding EL (specific for this repository)</b>||
|Part three| "how to" use the SPI flash in TouchGFX projects, "how to" install an EL into CubeIDE|https://youtu.be/PO_2ZE1NQF0|
|Part four| "how to" map an external SPI flash memory in a CubeIDE project||
<br>
<br>
...
|<b>Seconda parte</br>|<br>"how to" - creare EL a basso consumo di RAM (specifico per questa repository)</b>||
...
|Quarta parte|"how to" - come mappare una memoria flash SPI in un progetto CubeIDE||
